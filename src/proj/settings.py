...
SECRET_KEY = 's!wbm69+s+@bpb=%!u5%p0#95^=&pup_+xd=cv@6a2z1ww$(g2'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
            'app_tags': 'proj.templatetags.app_tags',
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ratomskayaitshop@gmail.com'
EMAIL_HOST_PASSWORD = 'itshop2020'
